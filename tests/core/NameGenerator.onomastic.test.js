...
describe("NameGenerator - Onomastic Rules", () => {
    ...
    describe('Interchangeable Component System ("Lego System")', () => {
        it("should allow components to be used as both prefix and suffix", () => {
            ...
            const flexibleComponents = generator.components.filter(
            ...
            const names = [];
            for (let i = 0; i < 50; i++) {
                // More attempts to increase chance of overlap
        ...
        it("should exclude gender modifiers from interchangeable pool in complex mode", () => {
            ...
            for (let i = 0; i < 20; i++) {
                ...
                if (result.components && result.components.length > 1) {
                    ...
                    nonFinalComponents.forEach((comp) => {
                        ...
                        if (
                            comp.component.can_be_prefix &&
                            comp.component.can_be_suffix &&
                            !comp.component.is_gender_modifier
                        ) {
                            flexibleCount++;
                        }
                    });
            ...
            if (totalNonFinal > 0) {
                ...
                expect(flexibleRate).toBeGreaterThan(0.9); // At least 90% should be flexible
            }
        });
    ...
    describe("Syllable Targeting Accuracy", () => {
        it("should respect target ±1 syllable tolerance", () => {
            ...
            expect(toleranceRate).toBeGreaterThan(0.8);
        });
