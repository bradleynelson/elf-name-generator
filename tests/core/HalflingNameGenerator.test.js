...
const personal = [
  { root: 'milo', prefix_text: 'Milo', prefix_meaning: 'gracious', can_be_prefix: true, can_be_suffix: true, gender: 'male', subrace: ['lightfoot'], prefix_phonetic: 'MY-loh' },
  { root: 'pella', prefix_text: 'Pella', prefix_meaning: 'stone', can_be_prefix: true, can_be_suffix: true, gender: 'female', subrace: ['stout'], prefix_phonetic: 'PEH-lah' }
];

const families = [
  { root: 'goodbarrel', text: 'Goodbarrel', meaning: 'brewkeeper', subrace: ['lightfoot'], phonetic: 'GOOD-bar-rel' },
  { root: 'thorngage', text: 'Thorngage', meaning: 'thorn hedge guardian', subrace: ['stout'], phonetic: 'THORN-gayj' }
];
