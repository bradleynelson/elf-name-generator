...
export function loadDwarvenTestData() {
    const firstNames = JSON.parse(readFileSync(join(__dirname, "../../data/dwarvenFirstNames.json"), "utf-8"));
    const clanNames = JSON.parse(readFileSync(join(__dirname, "../../data/dwarvenClanNames.json"), "utf-8"));
